...
def define_decimal_type(keyword):
    return CaselessKeyword(keyword) + Optional(Suppress("(") + Word(nums).setName("length").setResultsName("length") + Optional("," + Word(nums).setName("decimals").setResultsName("decimals")) + Suppress(")")) + Optional(CaselessKeyword("UNSIGNED").setParseAction(replaceWith(True)).setResultsName("unsigned")) + Optional(CaselessKeyword("ZEROFILL").setParseAction(replaceWith(True)).setResultsName('zerofill'))

def extend_to_integer_type(type_def):
    return type_def + Optional(CaselessKeyword("UNSIGNED").setParseAction(replaceWith(True)).setResultsName("unsigned")) + Optional(CaselessKeyword("ZEROFILL").setParseAction(replaceWith(True)).setResultsName("zerofill"))
...
def extend_to_character_type(type_def, binary=True):
    ...
    return type_def + Optional(CaselessKeyword("CHARACTER SET") + QuotedString("'").setResultsName("character_set")) + Optional(CaselessKeyword("COLLATE") + QuotedString("'").setResultsName("collation_name"))
...
data_type_syntax <<= (
    ...
    extend_to_character_type(CaselessKeyword("ENUM") + Suppress("(") + delimitedList(QuotedString("'")).setName("enum_values").setResultsName("value_list") + Suppress(")"), binary=False) |
    extend_to_character_type(CaselessKeyword("SET") + Suppress("(") + delimitedList(QuotedString("'")).setName("set_values").setResultsName("value_list") + Suppress(")"), binary=False) 
